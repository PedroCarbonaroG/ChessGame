...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc) {
        ...
        catch (RuntimeException e) { throw new InputMismatchException("Error reading ChessPosition. Valid values are from a1 to h8"); }
    }
    ...
    public static void printMatch(ChessMatch chessMatch, List<ChessPiece> capturedPieces) {
        ...
        if (chessMatch.getCheck()) { System.out.println("Player in CHECK: " + chessMatch.getCurrentPlayer()); }
    }
    ...
    private static void printCapturedPieces(List<ChessPiece> capturedPieces) {
        ...
        //MY WAY
        // System.out.print("Whites: "); white.forEach(key -> System.out.print(key + " "));
        // System.out.print("Blacks:  ");
    }
}
